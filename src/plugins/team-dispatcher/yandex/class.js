...
export default class YandexStaff {
  ...
  apiAbsence(user) {
    ...
    const expires = this._getCacheOption('apiAbsence') || hour;
  ...
  apiUserInfo(user) {
    ...
    const expires = this._getCacheOption('apiUserInfo') || day;
  ...
  apiUserWhere(user) {
    ...
    const expires = this._getCacheOption('apiUserWhere') || hour;
  ...
  apiJabberStatus(user) {
    ...
    const expires = this._getCacheOption('apiJabberStatus') || hour;
  ...
  apiGroupMembers(groupId) {
    ...
    const expires = this._getCacheOption('getGroupMembers') || day;
